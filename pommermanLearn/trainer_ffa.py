...
from agents.skynet_agents import StaticAgent    
...
from data_generator_ffa import DataGeneratorPommermanFFA
from dqn import DQN
...
def train(model=None, num_iterations=p.num_iterations, episodes_per_iter=p.episodes_per_iter, augmentors=[]) :
    ...
    if model == None:
        ...
        algo = model    
    data_generator = DataGeneratorPommermanFFA(
...
def main(args):
    ...
    train(augmentors=[DataAugmentor_v1()])
